    ...
    <Container>
      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        <Section>
          ...
          >
            Front end for Capital One's home equity offerings: prequalification
            process, home equity loans and home equity lines of credit
          </WorkGridItem>
        </Section>
      </SimpleGrid>
      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        ...
        <Section delay={0.5}>
          ...
          >
            Android app for clinical trial studies conducted on Android tablets
          </WorkGridItem>
        </Section>
      </SimpleGrid>
    </Container>
